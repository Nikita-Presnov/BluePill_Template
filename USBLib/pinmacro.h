...
// #define PM_BITMASK(reg, mask, val)                           \
//     do                                                       \
//     {                                                        \
...
//     {                                             \
//         if (bit < 8)                              \
//             _GPIO_CONFIG(port, bit, L, mode);     \
//         else                                      \
//             _GPIO_CONFIG(port, bit - 8, H, mode); \
//     } while (0)
...
//         {                                                         \
//             if (_marg3(descr))                                    \
//                 GPIO(_marg1(descr))->BRR = (1 << _marg2(descr));  \
//             else                                                  \
//                 GPIO(_marg1(descr))->BSRR = (1 << _marg2(descr)); \
//         }                                                         \
//     } while (0)
